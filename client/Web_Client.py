...
def start_tcpdump():
    ...
    """
    return subprocess.Popen(['tcpdump', '-i', 'any', '-w', 'pcap/web_client_capture.pcap', 'tcp and port 8000 and host 10.0.0.4'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def fetch_web_page():
    ...
    try:
        # Sending a GET request to fetch the web page at http://10.0.0.4:8000
        response = requests.get("http://10.0.0.4:8000")
